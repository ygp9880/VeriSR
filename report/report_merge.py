...
def merger(base_path,meta_name,save_file_path):
    report1_file_path = os.path.join(base_path, f"{meta_name}_report_1.json");
    ...
    for j in range(1, 6):
        report2_file_path = os.path.join(base_path, f"{meta_name}_report_2_{j}.json");
        ...
        for key in keys:
            if j == 2 and count == 3:
                ...
                report2_file_path = os.path.join(base_path, f"{meta_name}_report_2_2_3.txt");
            ...
            if j == 4 and count == 3:
                ...
                report2_file_path = os.path.join(base_path, f"{meta_name}_report_2_4_4.txt");
                report2_content = read_content(report2_file_path);
                add_text_to_doc(doc, report2_content);
            ...
            if isinstance(value, str):
                ...
                for key, item_value in value.items():
                    if key == "evidence":
                        continue
                    item = doc.add_paragraph(to_doc_text(item_value))
                ...
                if "evidence" in value:
                    ...
                    evidence_para = doc.add_paragraph(to_doc_text(value["evidence"]))
    ...
    report3_file_path = os.path.join(base_path, f"{meta_name}_report_3_1.json");
    ...
    report3_2_1_file_path = os.path.join(base_path, f"{meta_name}_report_3_2_1.json");
    ...
    result_file_path = os.path.join(base_path, f"extract_result_all_{meta_name}.json");
    ...
    file_path = os.path.join(base_path, f"{meta_name}_rob2_compare.txt");
