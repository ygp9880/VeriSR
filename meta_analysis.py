...
from prompt.extract_info import check_outcome;
...
#file_path = "txt\\meta-analyze.txt"  # 替换为你的文件路径
# process file

meta_name = "SR4";

base_path = f"D:\\project\\zky\\paperAgent\\all_txt\\{meta_name}";
...
file_path = f"D:\\project\\zky\\paperAgent\\all_txt\\{meta_name}.txt";
...
dump_result_to_file(extract_result, file_name);
