...
def normal_outcome(user_query:str, outcomes_json:str, model: str = DEFAULT_OPENAI_MODEL):
...
def check_outcome(user_query:str, outcomes_json:str, type:str, model: str = DEFAULT_OPENAI_MODEL):
    prompt = None;
...
# 3. Call the model
def extract_rob2_info(article_text, model: str = DEFAULT_OPENAI_MODEL):
    prompt = build_rob2_domin_prompt(article_text);
