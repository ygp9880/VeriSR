...
def extract_plain_info(article_text, type, model: str = DEFAULT_OPENAI_MODEL):
...
def extract_all_info(article_text, data_fields, model: str = DEFAULT_OPENAI_MODEL):
...
def extract_original_outcome_info(article_text, model: str = DEFAULT_OPENAI_MODEL):
