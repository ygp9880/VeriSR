...
from utils.client_utils import get_client, get_claude_client, get_genai_client;
...
def rob2_analysis(result,  domain_type, model=DEFAULT_OPENAI_MODEL):
    ...
    match_result = None;
    if (not model.__contains__('claude')) and (not model.__contains__('gemini')):
